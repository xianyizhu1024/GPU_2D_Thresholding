...
public:
    ...
    void loadModel(string path)
    {
		...
		const aiScene* scene = importer.ReadFile(path, aiProcess_GenSmoothNormals | aiProcess_JoinIdenticalVertices);//aiProcess_Triangulate |,  aiProcess_FlipUVs|aiProcess_GenNormals | aiProcess_CalcTangentSpace
        // Check for errors
